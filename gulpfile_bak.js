...
gulp.task("serve", gulp.series(["build:dev"], function(done){
  console.log("I start serve task!")
  bs.init({
    reloadDebounce: 200,
    port: c.port,
    server: {
  ...
  //watch resources
  gulp.watch(`${srcDir}/style/**/*.{scss,css}`, gulp.series("style"));
  gulp.watch(`${srcDir}/image/**/*.{png,jpg}`, gulp.series("image"));
  gulp.watch(`${srcDir}/pimg/**/*.{png,jpg}`, gulp.series("pimg"));
